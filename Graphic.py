...
for i in range(row-1):
    ...
    for j in range(col):
        ...
        if j==0:
            ...
            #draw.text(((l/3)+90+220*j, loc+20),s,(66,75,142),font=font,stroke_width=1, stroke_fill=(66,75,142))
            font = ImageFont.truetype("Requirements/ArialBold.ttf", 25, encoding="unic")
            draw.text(((l/3)+90+220*j, loc+20),s,(66,75,142),font=font)
        elif j==1:
            #font = ImageFont.truetype("Requirements/Yekan.ttf", 26, encoding="unic")
            #draw.text((l/2.1, loc+20),str(i+1),(66,75,142),font=font,stroke_width=1, stroke_fill=(66,75,142))
            #draw.text((l+90+220*j, loc+20),s,(66,75,142),font=font,stroke_width=1, stroke_fill=(66,75,142))
            font = ImageFont.truetype("Requirements/YekanBold.ttf", 32, encoding="unic")
            draw.text((l/2.1, loc+10),str(i+1),(66,75,142),font=font)
            draw.text((l+90+220*j, loc+10),s,(66,75,142),font=font)
        elif j==2:
            #font = ImageFont.truetype("Requirements/Yekan.ttf", 26, encoding="unic")
            #draw.text(((l/8)+90+265*j, loc+20),s,(66,75,142),font=font,stroke_width=1, stroke_fill=(66,75,142))
            font = ImageFont.truetype("Requirements/YekanBold.ttf", 32, encoding="unic")
            draw.text(((l/8)+90+265*j, loc+10),s,(66,75,142),font=font)
        elif j==3:
            #font = ImageFont.truetype("Requirements/Yekan.ttf", 26, encoding="unic")
            #draw.text((90+258*j, loc+20),s,(66,75,142),font=font,stroke_width=1, stroke_fill=(66,75,142))
            font = ImageFont.truetype("Requirements/YekanBold.ttf", 32, encoding="unic")
            draw.text((90+258*j, loc+10),s,(66,75,142),font=font)
...
draw.text((l+310,loc+75),s,(255,255,255),font=font,stroke_width=1, stroke_fill=(66,75,142))
